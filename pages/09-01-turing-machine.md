...
그러나 같은 손으로, 튜링은 계산의 한계도 그어 놓았다. 어떤 문제는 어떤 기계로도 풀 수 없다. 그 가운데 가장 유명한 것이 정지 문제(halting problem)다. 임의의 프로그램이 끝까지 돌고 멈출지, 아니면 영원히 돌지를 미리 판정하는 일반적 방법은 없다는 것. 멈춤을 내다보는 기계는, 원리적으로 만들 수 없다.
