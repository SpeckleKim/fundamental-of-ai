...
그리고 한 가지 약속을 해 두자. 본문 곳곳에는 **💡 심화**라고 표시된 대목이 있다. 더 깊이 파고드는 곁가지여서, **처음 읽을 때는 건너뛰어도 본문의 흐름에 전혀 지장이 없다.** 핵심만 따라 끝까지 한 바퀴 돌고 난 뒤, 더 알고 싶어질 때 다시 펼쳐 보면 된다. 처음부터 모든 것을 짊어지려 하지 말자. 기초를 차근차근 쌓는 데에는, 무엇을 지금 읽고 무엇을 나중으로 미룰지 가려내는 일도 포함된다.
